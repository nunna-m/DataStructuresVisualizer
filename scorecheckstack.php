<?php
	...
	$query="SELECT stack FROM qanswers";
...
<html>
	...
	<body>
		...
		<div id="d">/</div>
		<div id="out">5</div>
		<button style="position: absolute; top: 600px;left:500px;"><a href="stacksquiz.php" style="text-decoration:none;">Take the Test Again?</a></button>
		<button style="position: absolute; top: 600px;left:700px">Back to Stacks</button>
